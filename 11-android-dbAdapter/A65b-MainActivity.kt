...
import com.nachocabanes.ejemplosqlite.miSQLiteHelper.Companion.NOMBRE_TABLA
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btMostrar.setOnClickListener {
            ...
            val cursor = db.rawQuery(
                "SELECT * FROM $NOMBRE_TABLA ORDER BY nombre",
                null
            )
        ...
        binding.btMostrarLV.setOnClickListener {
            val intent = Intent(this, ActivityListView::class.java)
            startActivity(intent)
        }

        binding.btMostrarRV.setOnClickListener {
